    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (savedState) {
                ...
                // Проверяем, совпадают ли текущие параметры с сохранёнными
                ...
                if (
                    ...
                    // Если есть scroll_to, прокручиваем к конкретной задаче
                    if (scrollToTaskId) {
                        ...
                        // Иначе восстанавливаем сохранённую позицию прокрутки
                        window.scrollTo(0, state.scrollPosition);
                    }
                }
                // Очищаем сохранённое состояние после восстановления
